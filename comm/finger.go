...
// Finger returns the canonical form of q. The primary transformations are:
//   - Replace values with ?
//   - Collapse whitespace
//   - Remove comments
...
func Finger(q string) string {
	...
	str := strings.ReplaceAll(string(f[0:fi]), "\x00", "")
...
func FingerID(fingerprint string) string {
	id := md5.New()
