...
func TestDML2Select(t *testing.T) {
	tests := []struct {
		...
		{"test008", "INSERT INTO students (id, name, age) VALUES (1, 'Tom', 18), (2, 'Jerry', 20), (3, 'Mike', 22), (4, 'Lucy', 19), (5, 'Bob', 21);", "select 3"},
		{"test009", "INSERT INTO students_above_20 (id, name, age, gender) SELECT id, name, age, gender FROM students WHERE age > 20;", "select id, name, age, gender from students where age > 20"},
		{"test100", "update test.student a, test1.student1 b set a.name = 'a', b.name = 'b' WHERE a.phone = '1'", "select * from test.student as a, test1.student1 as b where a.phone = '1'"},
	}
